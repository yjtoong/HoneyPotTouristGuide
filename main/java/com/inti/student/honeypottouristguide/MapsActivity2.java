...
public abstract class MapsActivity2 extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.B_police:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby Police Station", Toast.LENGTH_SHORT).show();
                break;
